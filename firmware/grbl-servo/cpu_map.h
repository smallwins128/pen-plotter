...
#define cpu_map_h
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define SPINDLE_PWM_MAX_VALUE     39  // 39*64us = 2496us servo pulse [PLOTTER EDIT 2]
    #ifndef SPINDLE_PWM_MIN_VALUE
      #define SPINDLE_PWM_MIN_VALUE   8   // 8*64us = 512us servo pulse [PLOTTER EDIT 2]
    #endif
    ...
    #define SPINDLE_TCCRB_INIT_MASK      ((1<<CS22)|(1<<CS21)|(1<<CS20)) // 1/1024 -> 61.0Hz RC SERVO FRAME [PLOTTER EDIT 1]
